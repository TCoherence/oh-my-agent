...
- Optional LLM router implemented (canonical 5-intent contract: `chat_reply` / `invoke_skill` / `oneoff_artifact` / `propose_repo_change` / `update_skill`).
