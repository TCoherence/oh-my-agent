...
- `seattle-metro-housing-watch` and `market-briefing` skill contracts iterated; `market-briefing` includes podcast prefetch + AI daily 4-section checkpointing (Stage 2.2) reading paper-digest JSON directly.
